  ...
  struct GeoDrawerSVGTests {
    ...
    @Test func testPolygonSVG() throws {
      ...
      let expectedSVG = """
        <?xml version="1.0" encoding="UTF-8"?>
        <svg width="400.0" height="200.0" viewBox="0 0 400.0 200.0" xmlns="http://www.w3.org/2000/svg">
        <path d="M 188.9 88.9 L 211.1 88.9 L 211.1 111.1 L 188.9 111.1 L 188.9 88.9 Z" fill="#00FF00" stroke="#0000FF" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        """
    ...
    @Test func testPolygonWithHoles() throws {
      ...
      let expectedSVG = """
        <?xml version="1.0" encoding="UTF-8"?>
        <svg width="400.0" height="200.0" viewBox="0 0 400.0 200.0" xmlns="http://www.w3.org/2000/svg">
        <path d="M 177.8 77.8 L 222.2 77.8 L 222.2 122.2 L 177.8 122.2 L 177.8 77.8 Z M 188.9 88.9 L 211.1 88.9 L 211.1 111.1 L 188.9 111.1 L 188.9 88.9 Z" fill="#00FF00" fill-rule="evenodd" />
        </svg>
        """
    ...
    @Test func testComplexMap() throws {
      ...
      let expectedSVG = """
        ...
        <path d="M 192.1 112.4 L 207.4 98.7 L 214.7 106.9 L 198.4 126.4 L 192.1 112.4 Z" fill="#CCE5CC" stroke="#4C7F4C" stroke-width="2.0" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M 252.3 85.5 L 255.2 82.9 L 256.7 84.2" stroke="#0000FF" stroke-width="2.0" stroke-linecap="round" stroke-linejoin="round" fill="none" />
