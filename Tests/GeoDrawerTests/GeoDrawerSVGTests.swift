...
struct GeoDrawerSVGTests {
  ...
  @Test func testPolygonSVG() throws {
    ...
    let polygon = GeoJSON.Polygon(exterior: .init(positions: [
    ...
    let content: [GeoDrawer.Content] = [
      .polygon(polygon, fill: testColor(red: 0, green: 1, blue: 0), stroke: testColor(red: 0, green: 0, blue: 1), strokeWidth: 1)
    ]
  ...
  @Test func testCircleSVG() throws {
    ...
    let content: [GeoDrawer.Content] = [
      .circle(.init(latitude: 0, longitude: 0), radius: 10, fill: testColor(red: 1, green: 0, blue: 0))
    ]
  ...
  @Test func testComplexMap() throws {
    ...
    let country = GeoJSON.Polygon(exterior: .init(positions: [
    ...
    let content: [GeoDrawer.Content] = [
      .polygon(country, fill: testColor(red: 0.8, green: 0.9, blue: 0.8), stroke: testColor(red: 0.3, green: 0.5, blue: 0.3)),
      .line(coastline, stroke: testColor(red: 0, green: 0, blue: 1), strokeWidth: 2),
      .circle(.init(latitude: 40.7, longitude: -74), radius: 8, fill: testColor(red: 1, green: 0, blue: 0))
    ]
  ...
  private func testColor(red: Double, green: Double, blue: Double, alpha: Double = 1.0) -> GeoDrawer.Color {
#if canImport(CoreGraphics)
