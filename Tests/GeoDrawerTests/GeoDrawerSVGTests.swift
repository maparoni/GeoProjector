  ...
  struct GeoDrawerSVGTests {
    ...
    @Test func testPolygonSVG() throws {
      ...
      let expectedSVG = """
        <?xml version="1.0" encoding="UTF-8"?>
        <svg width="400.0" height="200.0" viewBox="0 0 400.0 200.0" xmlns="http://www.w3.org/2000/svg">
        <path d="M 188.9 88.9 L 211.1 88.9 L 211.1 88.9 L 211.1 111.1 L 211.1 111.1 L 188.9 111.1 L 188.9 111.1 L 188.9 88.9 Z" fill="#00FF00" stroke="#0000FF" stroke-width="1.0" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        """
    ...
    @Test func testMapBackgroundAndOutline() throws {
      ...
      let expectedSVG = """
        ...
        <rect x="0.0" y="0.0" width="400.0" height="200.0" fill="#CCCCFF" />
        <rect x="0.0" y="0.0" width="400.0" height="200.0" stroke="#000000" stroke-width="2.0" />
        </svg>
        """
    ...
    @Test func testColorConversion() throws {
      ...
      let expectedSVG = """
        ...
        <path d="M 50.0 50.0 L 52.8 47.2" stroke="#FF0000" stroke-width="2.0" stroke-linecap="round" stroke-linejoin="round" fill="none" />
        <circle cx="51.4" cy="48.6" r="2.5" fill="rgba(0,0,255,0.5)" />
        </svg>
        """
    ...
    @Test func testPolygonWithHoles() throws {
      ...
      let expectedSVG = """
        <?xml version="1.0" encoding="UTF-8"?>
        <svg width="400.0" height="200.0" viewBox="0 0 400.0 200.0" xmlns="http://www.w3.org/2000/svg">
        <path d="M 177.8 77.8 L 222.2 77.8 L 222.2 77.8 L 222.2 122.2 L 222.2 122.2 L 177.8 122.2 L 177.8 122.2 L 177.8 77.8 Z M 188.9 88.9 L 211.1 88.9 L 211.1 88.9 L 211.1 111.1 L 211.1 111.1 L 188.9 111.1 L 188.9 111.1 L 188.9 88.9 Z" fill="#00FF00" fill-rule="evenodd" />
        </svg>
        """
    ...
    @Test func testComplexMap() throws {
      ...
      let expectedSVG = """
        ...
        <path d="M 163.0 5.3 L 637.0 5.3 L 637.0 5.3 L 637.8 5.7 L 640.2 6.7 L 644.1 8.4 L 649.3 10.7 L 655.6 13.7 L 662.8 17.1 L 678.8 25.5 L 695.7 35.5 L 712.4 46.9 L 728.3 59.4 L 742.8 72.9 L 755.9 87.1 L 767.4 102.1 L 777.2 117.6 L 785.4 133.6 L 791.7 149.9 L 796.3 166.4 L 799.1 183.2 L 800.0 200.0 L 799.1 216.8 L 796.3 233.6 L 791.7 250.1 L 785.4 266.4 L 777.2 282.4 L 767.4 297.9 L 755.9 312.9 L 742.8 327.1 L 728.3 340.6 L 712.4 353.1 L 695.7 364.5 L 678.8 374.5 L 662.8 382.9 L 655.6 386.3 L 649.3 389.3 L 644.1 391.6 L 640.2 393.3 L 637.8 394.3 L 637.0 394.7 L 637.0 394.7 L 163.0 394.7 L 163.0 394.7 L 162.2 394.3 L 159.8 393.3 L 155.9 391.6 L 150.7 389.3 L 144.4 386.3 L 137.2 382.9 L 121.2 374.5 L 104.3 364.5 L 87.6 353.1 L 71.7 340.6 L 57.2 327.1 L 44.1 312.9 L 32.6 297.9 L 22.8 282.4 L 14.6 266.4 L 8.3 250.1 L 3.7 233.6 L 0.9 216.8 L 0.0 200.0 L 0.9 183.2 L 3.7 166.4 L 8.3 149.9 L 14.6 133.6 L 22.8 117.6 L 32.6 102.1 L 44.1 87.1 L 57.2 72.9 L 71.7 59.4 L 87.6 46.9 L 104.3 35.5 L 121.2 25.5 L 137.2 17.1 L 144.4 13.7 L 150.7 10.7 L 155.9 8.4 L 159.8 6.7 L 162.2 5.7 L 163.0 5.3 Z" fill="#B2CCFF" />
        <path d="M 192.1 112.4 L 207.4 98.7 L 207.4 98.7 L 214.7 106.9 L 214.7 106.9 L 198.4 126.4 L 198.4 126.4 L 192.1 112.4 Z" fill="#CCE5CC" stroke="#4C7F4C" stroke-width="2.0" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M 252.3 85.5 L 255.2 82.9 L 255.2 82.9 L 256.7 84.2" stroke="#0000FF" stroke-width="2.0" stroke-linecap="round" stroke-linejoin="round" fill="none" />
        <path d="M 163.0 5.3 L 637.0 5.3 L 637.0 5.3 L 637.8 5.7 L 640.2 6.7 L 644.1 8.4 L 649.3 10.7 L 655.6 13.7 L 662.8 17.1 L 678.8 25.5 L 695.7 35.5 L 712.4 46.9 L 728.3 59.4 L 742.8 72.9 L 755.9 87.1 L 767.4 102.1 L 777.2 117.6 L 785.4 133.6 L 791.7 149.9 L 796.3 166.4 L 799.1 183.2 L 800.0 200.0 L 799.1 216.8 L 796.3 233.6 L 791.7 250.1 L 785.4 266.4 L 777.2 282.4 L 767.4 297.9 L 755.9 312.9 L 742.8 327.1 L 728.3 340.6 L 712.4 353.1 L 695.7 364.5 L 678.8 374.5 L 662.8 382.9 L 655.6 386.3 L 649.3 389.3 L 644.1 391.6 L 640.2 393.3 L 637.8 394.3 L 637.0 394.7 L 637.0 394.7 L 163.0 394.7 L 163.0 394.7 L 162.2 394.3 L 159.8 393.3 L 155.9 391.6 L 150.7 389.3 L 144.4 386.3 L 137.2 382.9 L 121.2 374.5 L 104.3 364.5 L 87.6 353.1 L 71.7 340.6 L 57.2 327.1 L 44.1 312.9 L 32.6 297.9 L 22.8 282.4 L 14.6 266.4 L 8.3 250.1 L 3.7 233.6 L 0.9 216.8 L 0.0 200.0 L 0.9 183.2 L 3.7 166.4 L 8.3 149.9 L 14.6 133.6 L 22.8 117.6 L 32.6 102.1 L 44.1 87.1 L 57.2 72.9 L 71.7 59.4 L 87.6 46.9 L 104.3 35.5 L 121.2 25.5 L 137.2 17.1 L 144.4 13.7 L 150.7 10.7 L 155.9 8.4 L 159.8 6.7 L 162.2 5.7 L 163.0 5.3 Z" fill="none" stroke="#333333" stroke-width="2.0" />
        <circle cx="254.9" cy="83.7" r="4.0" fill="#FF0000" />
        </svg>
        """
